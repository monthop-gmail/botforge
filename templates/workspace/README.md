...
Workspace สำหรับ {{PROJECT_NAME}} LINE Bot — generated by [Botforge](https://github.com/{{GITHUB_ORG}}/botforge)
...
|------|-----------|-------------|
| `{{GITHUB_ORG}}/{{PROJECT_NAME}}` | Public | Bot source code |
| `{{GITHUB_ORG}}/{{PROJECT_NAME}}-workspace` | Private | Workspace นี้ |
